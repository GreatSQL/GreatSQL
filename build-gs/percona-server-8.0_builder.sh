...
#   ./generate-version.sh
    ...
    if [ $LOCAL_BOOST = 0 ]
    then
      cmake3 ${CURDIR}/..  -DWITH_SSL=system -DWITH_ZLIB=bundled -DWITH_TOKUDB=0 -DWITH_ROCKSDB=1 -DGROUP_REPLICATION_WITH_ROCKSDB=OFF -DALLOW_NO_SSE42=ON -DFORCE_INSOURCE_BUILD=1 -DWITH_AUTHENTICATION_LDAP=OFF -DDOWNLOAD_BOOST=1 -DWITH_BOOST=${CURDIR}/boost_1_77_0.tar.bz2
    else
      tar -xzvf ${CURDIR}/boost_1_77_0.tar.gz -C ${CURDIR}
      cmake3 ${CURDIR}/..  -DWITH_SSL=system -DWITH_ZLIB=bundled -DWITH_TOKUDB=0 -DWITH_ROCKSDB=1 -DGROUP_REPLICATION_WITH_ROCKSDB=OFF -DALLOW_NO_SSE42=ON -DFORCE_INSOURCE_BUILD=1 -DWITH_AUTHENTICATION_LDAP=OFF -DDOWNLOAD_BOOST=0 -DWITH_BOOST=${CURDIR}/boost_1_77_0
    fi
    make dist
    #
