 ...
 public:
  ...
  /**
    ...
    @returns
      ...
      false on success
  */
  virtual bool create_result_table(THD *thd, ulonglong options,
...
class Table_function_record final : public Table_function {
 public:
  Table_function_record(const char *alias, List<Create_field> vt_list,
                        sp_variable *spv, Item *forall_i, bool is_str_index,
                        const Sp_rcontext_handler *rh, Query_arena *rtx_arena,
                        sp_variable *spv_i)
      : Table_function(),
        m_table_alias(alias),
        m_vt_list(vt_list),
  ...
  /**
    Returns function's name
  */
  const char *func_name() const override { return "record_table"; }
  /**
    Initialize the table function before creation of result table
  ...
  */
  ...
  bool fill_result_table_all_col(THD *thd, const mem_root_deque<Item *> &items,
                                 Item *item_index, bool is_bulk_into);
 ...
 private:
  ...
  // rcontext's caller_arena
  Query_arena *m_rtx_arena;
  sp_variable *m_spv_i;
  ...
  */
  ...
  void cleanup() { m_first_last_str_list.clear(); }
  bool fill_forall_table_with_udt_table(THD *thd,
                                        Table_function_record *table_from);

 private:
  bool init_udt_table();
  bool init_udt_type();
  bool fill_result_table_with_udt_table();
  bool fill_result_table_with_udt_type();
};
...
class Table_function_udt final : public Table_function {
 public:
  ...
  /**
    Returns function's name
  */
  const char *func_name() const override { return "udt_table"; }
  /**
    Initialize the table function before creation of result table
