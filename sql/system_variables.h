...
inline constexpr sql_mode_t MODE_ORACLE = (1ULL << 9);
...
// sysdate_is_now
inline constexpr sql_mode_t MODE_SYSDATE_IS_NOW = 1ULL << 33;

/*
  The empty string is equal to null in MODE_EMPTYSTRING_EQUAL_NULL mode
*/
inline constexpr sql_mode_t MODE_EMPTYSTRING_EQUAL_NULL = 1ULL << 34;

inline constexpr sql_mode_t MODE_LAST = 1ULL << 35;
