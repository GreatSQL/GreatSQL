...
class Gtid_set {
  ...
  */
  ...
  /**
    What is the count of all the GTIDs in all intervals for all sidno

    @return the number of all GTIDs in all intervals for all sidno
  */
  ulonglong get_all_gtid_count() const;
