...
class PT_table_record_function : public PT_table_reference {
 ...
 public:
  PT_table_record_function(const LEX_STRING &table_alias,
                           const LEX_STRING &forall_i)
...
class PT_table_udt_function : public PT_table_reference {
 ...
 public:
  PT_table_udt_function(Item *expr, const LEX_CSTRING &table_alias)
      : m_expr(expr), m_table_alias(table_alias) {}
...
class PT_select_sp_var : public PT_select_var {
 ...
 public:
  ...
  bool var_is_record_type() override { return is_record_define_type; }
  bool var_is_record_table_define_type() override {
