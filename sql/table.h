...
struct ORDER {
 ...
 public:
  ...
  /* requested nulls position of ordering. default to MYSQL style */
  enum enum_nulls_position nulls_pos { NULLS_POS_MYSQL };
...
struct TABLE_SHARE {
  ...
  */
  ...
  uint *udt_field{nullptr};  /* Index to udt col in Field array */
  ...
  */
  ...
  materialized_view_info *mview_info{nullptr};
...
struct TABLE {
  ...
  */
  ...
  /**
    record all columns which appeared in the query select list
  */
  MY_BITMAP def_select_list_set;
  MY_BITMAP *select_list_set{nullptr};
#endif
 ...
 public:
  ...
  bool init_tmp_table(THD *thd, TABLE_SHARE *share, MEM_ROOT *m_root,
                      ...
                      uint *blob_fld, bool is_virtual, uint *udt_fld = nullptr);
...
class Table_ref {
  ...
  */
  ...
  /// Check if we can push outer limit to this derived table
  bool can_push_limit_to_derived() const;
