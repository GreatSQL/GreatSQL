...
extern MY_LOCALE *errorlog_lc_messages;
...
extern bool enable_recycle_bin;
...
extern uint replication_error_write_file;
...
enum enum_replica_parallel_wait_mode {
  REPLICA_WAIT_ON_SQL_THREAD = 0,
  REPLICA_WAIT_ON_WORKER_THREAD = 1,
};
extern ulong opt_replica_parallel_wait_mode;
