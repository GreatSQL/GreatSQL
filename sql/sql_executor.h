...
class QEP_TAB : public QEP_shared_owner {
 public:
  ...
  // AccessPath *quick_optim() const { return m_quick_optim; }
  // void set_quick_optim() { m_quick_optim = range_scan(); }
  // AccessPath *old_quick_optim() const { return m_old_quick_optim; }
  // void set_old_quick_optim() { m_old_quick_optim = range_scan(); }
  ...
  */
  ...
  // AccessPath *m_quick_optim;
  // AccessPath *m_old_quick_optim;
