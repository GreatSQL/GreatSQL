...
#define HA_CREATE_MATERIALIZED_VIEW (1L << 38)
#define HA_CREATE_MATERIALIZED_VIEW_LOG (1L << 39)
...
class Ha_clone_cbk {
 ...
 public:
  ...
  void enable_encryption(my_aes_opmode encrypt_mode, char *encrypt_key,
                         char *encrypt_iv) {
    m_encrypt_mode = encrypt_mode;
    m_encrypt_key = encrypt_key;
    m_encrypt_iv = encrypt_iv;
  }

  bool encryption() { return m_encrypt_key && m_encrypt_iv; }
...
struct mlog_info {
  LEX_CSTRING ref_db;
  dd::String_type ref_table_name;
  LEX_CSTRING trigger_name;
};

struct materialized_view_info {
  int build_clasue;
  int flush_mode;
  int with_row_id;
  // query has transformed
  LEX_STRING create_view_query_block{nullptr, 0};
  // source query
  LEX_STRING create_view_define{nullptr, 0};
  LEX_STRING table_ref{nullptr, 0};
  LEX_STRING derived_columns{nullptr, 0};
};
...
struct HA_CREATE_INFO {
  ...
  */
  ...
  materialized_view_info *m_mv_info{nullptr};
  ...
  */
  ...
  // mlog reference_table
  mlog_info *m_mlog_info{nullptr};
};
