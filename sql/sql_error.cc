...
void Sql_condition::copy_opt_attributes(const Sql_condition *cond) {
  ...
  set_user_defined_exception(cond->get_user_defined());
}

void Sql_condition::set_user_defined_exception(sp_condition_value *value) {
...
sp_condition_value *Diagnostics_area::user_defined() const {
...
Sql_condition *Diagnostics_area::push_warning(
  ...
  if (m_allow_unlimited_conditions ||
    ...
    if (thd->variables.sql_mode & MODE_ORACLE) {
      cond->set_user_defined_exception(user_defined);
    }
