...
ulong Security_context::type_acl(LEX_CSTRING db, LEX_CSTRING type_name) {
  if (m_acl_map == nullptr)
    return 0;
  else {
    SP_access_map::iterator it;
...
ulong Security_context::package_acl(LEX_CSTRING db, LEX_CSTRING package_name) {
  if (m_acl_map == nullptr)
    return 0;
  else {
    SP_access_map::iterator it;
...
ulong Security_context::package_body_acl(LEX_CSTRING db,
