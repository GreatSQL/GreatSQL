...
class Security_context {
  ...
  */
  ...
  ulong type_acl(LEX_CSTRING db, LEX_CSTRING type_name);
  ulong package_acl(LEX_CSTRING db, LEX_CSTRING package_name);
  ulong package_body_acl(LEX_CSTRING db, LEX_CSTRING package_name);
