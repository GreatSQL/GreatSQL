...
class Security_context {
  ...
  */
  ...
  Access_bitmask type_acl(LEX_CSTRING db, LEX_CSTRING type_name);
  Access_bitmask package_acl(LEX_CSTRING db, LEX_CSTRING package_name);
  Access_bitmask package_body_acl(LEX_CSTRING db, LEX_CSTRING package_name);
