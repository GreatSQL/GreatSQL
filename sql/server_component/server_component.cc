...
BEGIN_SERVICE_IMPLEMENTATION(mysql_server, mysql_thd_gdb_current_user)
mysql_gdb_current_user_imp::get END_SERVICE_IMPLEMENTATION();
...
PROVIDES_SERVICE(mysql_server_path_filter, dynamic_loader_scheme_file),
    ...
    PROVIDES_SERVICE(mysql_server, mysql_thd_gdb_current_user),
