...
bool Async_conn_failover_manager::set_channel_conn_details(
  ...
  */
  DBUG_SIGNAL_WAIT_FOR(current_thd, "wait_auto_failover",
                       "terminate_slave_thread_pause_1",
                       "terminate_slave_thread_continue_1");
  ...
  */
  ...
  mi->channel_unlock();
  DBUG_SIGNAL_WAIT_FOR(current_thd, "wait_auto_failover",
                       "terminate_slave_thread_pause_2",
                       "terminate_slave_thread_continue_2");
  return error;
}
