...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM("BIT", BIT_SYM)},
    {SYM("BINARY_DOUBLE", DOUBLE_SYM)},
    {SYM("BINARY_FLOAT", FLOAT_SYM)},
    {SYM("BINARY_INTEGER", BINARY_INTEGER_SYM)},
    {SYM("BLOB", BLOB_SYM)},
    {SYM("BLOCK", BLOCK_SYM)},
    {SYM("BODY", BODY_SYM)},
    {SYM("BOOL", BOOL_SYM)},
    ...
    {SYM("COMPLETE", COMPLETE_SYM)},
    {SYM("CONCURRENT", CONCURRENT)},
    {SYM("CONDITION", CONDITION_SYM)},
    {SYM("CONNECT", CONNECT_SYM)},
    {SYM("CONNECT_BY_ROOT", CONNECT_BY_ROOT_SYM)},
    {SYM("CONNECT_BY_ISCYCLE", CONNECT_BY_ISCYCLE_SYM)},
    {SYM("CONNECT_BY_ISLEAF", CONNECT_BY_ISLEAF_SYM)},
    ...
    {SYM("DELETING", DELETING)},
    {SYM("DEFERRED", DEFERRED_SYM)},
    {SYM("DEMAND", DEMAND_SYM)},
    ...
    {SYM("INT4", INT_SYM)},
    {SYM("INT8", BIGINT_SYM)},
    {SYM("PLS_INTEGER", INT_SYM)}, /* Put it here to avoid affecting the alias
                                      test cast func_digest */
    {SYM("INTEGER", INT_SYM)},
    ...
    {SYM("MONTH", MONTH_SYM)},
    {SYM("MONTHS_BETWEEN", MONTHS_BETWEEN)},
    ...
    {SYM("NOCACHE", NO_CACHE_SYM)},
    {SYM("NOCYCLE", NO_CYCLE_SYM)},
    {SYM("NOMAXVALUE", NO_MAXVALUE_SYM)},
    {SYM("NOMINVALUE", NO_MINVALUE_SYM)},
    {SYM("NOORDER", NO_ORDER_SYM)},
    ...
    {SYM("NVARCHAR2", NVARCHAR_SYM)},
    {SYM("OBJECT", OBJECT_SYM)},
    {SYM("OF", OF_SYM)},
    {SYM("OFF", OFF_SYM)},
    ...
    {SYM("RANGE", RANGE_SYM)},
    {SYM("RAISE", RAISE_SYM)},
    {SYM("RATIO_TO_REPORT", RATIO_TO_REPORT_SYM)},
    {SYM("RAW", RAW_SYM)},
    {SYM("READ", READ_SYM)},
    ...
    {SYM("SEQUENCE", SEQUENCE_SYM)},  // add for GreatDB sequence
    {SYM("SEQUENCES", SEQUENCES)},    // add for GreatDB sequence
    ...
    {SYM("SERVEROUTPUT", SERVEROUTPUT_SYM)},
    {SYM("SET", SET_SYM)},
    {SYM("SHARE", SHARE_SYM)},
    {SYM("SHOW", SHOW)},
    ...
    */
    ...
    {SYM_FN("DECODE", DECODE_SYM)},
    {SYM_FN("DUMP", DUMP_SYM)},
    {SYM_FN("EXCEPTION_INIT", EXCEPTION_INIT)},
    {SYM_FN("EXTRACT", EXTRACT_SYM)},
    {SYM_FN("GROUP_CONCAT", GROUP_CONCAT_SYM)},
    {SYM_FN("WM_CONCAT", WM_CONCAT_SYM)},
    ...
    {SYM_FN("RAISE_APPLICATION_ERROR", RAISE_APPLICATION_ERROR)},
    ...
    {SYM_FN("SUBSTRB", SUBSTRB_SYM)},
    {SYM_FN("SYS_GUID", SYS_GUID_SYM)},
    {SYM_FN("SUBSTRING", SUBSTRING)},
    {SYM_FN("SUM", SUM_SYM)},
    {SYM_FN("SYSTEM_USER", USER)},
    {SYM_FN("TRIM", TRIM)},
    {SYM_FN("TO_NUMBER", TO_NUMBER_SYM)},
    ...
    */
    ...
    /*
      Insert new optimizer hint for oracle
    */
    {SYM_H("USE_HASH", HASH_JOIN_HINT)},
    {SYM_H("NO_USE_HASH", NO_HASH_JOIN_HINT)},
    {SYM_H("ADD_EQUAL", INDEX_MERGE_HINT)},
    {SYM_H("INDEX_JOIN", JOIN_INDEX_HINT)},
    {SYM_H("LEADING", JOIN_PREFIX_HINT)},
    {SYM_H("INDEX_ASC", ORDER_INDEX_HINT)},
    {SYM_H("INDEX_SS", SKIP_SCAN_HINT)},
    {SYM_H("NO_INDEX_SS", NO_SKIP_SCAN_HINT)}};
#endif /* LEX_INCLUDED */
