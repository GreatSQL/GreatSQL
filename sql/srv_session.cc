...
Srv_session::Session_backup_and_attach::Session_backup_and_attach(
  ...
  if (backup_thd) {
    ...
    pfs_backup_thread_id = PSI_THREAD_CALL(get_thread_id)(psi);
    pfs_backup_thd = PSI_THREAD_CALL(get_thread_THD)(psi);
  }
#endif
...
#ifdef HAVE_PSI_THREAD_INTERFACE
    struct PSI_thread *psi = PSI_THREAD_CALL(get_thread)();
    PSI_THREAD_CALL(set_thread_id)(psi, pfs_backup_thread_id);
    PSI_THREAD_CALL(set_thread_THD)(psi, pfs_backup_thd);
