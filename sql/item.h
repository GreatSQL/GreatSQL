...
class Item_splocal_row_field_table_by_ident
    : public Item_splocal_row_field_by_name {
  uint m_number_idx;
  sp_pcontext *m_pctx;

 public:
  Item_splocal_row_field_table_by_ident(const Sp_rcontext_handler *rh,
                                        const Name_string sp_var_name,
                                        const Name_string sp_field_name,
                                        uint sp_var_idx, uint number_idx,
                                        sp_pcontext *pctx, uint pos_in_q = 0,
                                        uint len_in_q = 0)
      : Item_splocal_row_field_by_name(rh, sp_var_name, sp_field_name,
                                       sp_var_idx, MYSQL_TYPE_NULL, pos_in_q,
                                       len_in_q),
