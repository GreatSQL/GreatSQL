...
#include "sql/dd/impl/types/materialized_view_impl.h"    // IWYU pragma: keep
#include "sql/dd/impl/types/mlog_impl.h"                 // IWYU pragma: keep
...
template Materialized_view_log *&
Collection<Materialized_view_log *>::Collection_iterator::operator*();
template Materialized_view *&
Collection<Materialized_view *>::Collection_iterator::operator*();
...
template const Materialized_view_log *&
Collection<Materialized_view_log *>::Collection_const_iterator::operator*();
template const Materialized_view *&
Collection<Materialized_view *>::Collection_const_iterator::operator*();
...
template bool Collection<Materialized_view_log *>::restore_items<Table_impl>(
    Table_impl *, Open_dictionary_tables_ctx *, Raw_table *, Object_key *);
template bool Collection<Materialized_view *>::restore_items<Table_impl>(
    Table_impl *, Open_dictionary_tables_ctx *, Raw_table *, Object_key *);
...
template bool Collection<Check_constraint *>::store_items(
    Open_dictionary_tables_ctx *);
template bool Collection<Materialized_view_log *>::store_items(
    Open_dictionary_tables_ctx *);
template bool Collection<Materialized_view *>::store_items(
    Open_dictionary_tables_ctx *);
...
template bool Collection<Check_constraint *>::drop_items(
    Open_dictionary_tables_ctx *, Raw_table *, Object_key *) const;
template bool Collection<Materialized_view_log *>::drop_items(
    Open_dictionary_tables_ctx *, Raw_table *, Object_key *) const;
template bool Collection<Materialized_view *>::drop_items(
    Open_dictionary_tables_ctx *, Raw_table *, Object_key *) const;
...
template void Collection<Materialized_view_log *>::clear_all_items();
template void Collection<Materialized_view *>::clear_all_items();
...
template void Collection<Materialized_view *>::clear_removed_items();
template void Collection<Materialized_view_log *>::clear_removed_items();
...
template void Collection<Materialized_view *>::remove(Materialized_view_impl *);
template void Collection<Materialized_view_log *>::remove(
...
template const Collection<Materialized_view_log *>::abstract_type *
Collection<Materialized_view_log *>::at(size_t n) const;
template const Collection<Materialized_view *>::abstract_type *
Collection<Materialized_view *>::at(size_t n) const;
...
template void Collection<Materialized_view_log *>::deep_copy<Table_impl>(
    Collection<Materialized_view_log *> const &, Table_impl *);
template void Collection<Materialized_view *>::deep_copy<Table_impl>(
    Collection<Materialized_view *> const &, Table_impl *);
