...
class Dictionary_client {
  ...
  */
  ...
  /**
   * @brief get mlog by tables
   *
   *
   * @param parent_schema
   * @param parent_name
   * @param children_schemas
   ...
   * @return false
   */
  [[nodiscard]] bool find_all_mlog(std::vector<String_type> *parent_schema,
  ...
  /**
   * @brief get imv names which imv ref mlogs
   *
   * @param skip_same_db
   * @param schema_name
   * @param mlog
