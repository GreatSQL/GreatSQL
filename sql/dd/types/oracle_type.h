...
#ifndef DD__ORACLE_TYPE_INCLUDED
#define DD__ORACLE_TYPE_INCLUDED
...
class Oracle_type_impl;

///////////////////////////////////////////////////////////////////////////

class Oracle_type : virtual public Routine {
 public:
  typedef Oracle_type_impl Impl;
  ...
  */
  Oracle_type *clone() const override = 0;
  Oracle_type *clone_dropped_object_placeholder() const override = 0;

  static void create_mdl_key(const String_type &schema_name,
                             const String_type &name, MDL_key *key) {
    Routine::create_mdl_key(RT_TYPE, schema_name, name, key);
  }
};
...
#endif  // DD__ORACLE_TYPE_INCLUDED
