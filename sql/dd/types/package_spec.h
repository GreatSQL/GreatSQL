...
#ifndef DD__PACKAGE_SPEC_INCLUDED
#define DD__PACKAGE_SPEC_INCLUDED
...
class Package_spec_impl;

///////////////////////////////////////////////////////////////////////////

class Package_spec : virtual public Routine {
 public:
  typedef Package_spec_impl Impl;
  ...
  */
  Package_spec *clone() const override = 0;
  Package_spec *clone_dropped_object_placeholder() const override = 0;

  static void create_mdl_key(const String_type &schema_name,
                             const String_type &name, MDL_key *key) {
    Routine::create_mdl_key(RT_PACKAGE_SPEC, schema_name, name, key);
  }
};
...
#endif  // DD__PACKAGE_SPEC_INCLUDED
