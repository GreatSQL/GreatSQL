...
class Schema : virtual public Entity_object {
 ...
 public:
  ...
  virtual Package_body *create_package_body(THD *thd) const = 0;

  virtual Package_spec *create_package_spec(THD *thd) const = 0;

  virtual Oracle_type *create_ora_type(THD *thd) const = 0;
