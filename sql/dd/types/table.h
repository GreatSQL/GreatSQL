...
#include "sql/dd/types/materialized_view.h"  //dd::materialized_view
#include "sql/dd/types/mlog.h"               // IWYU pragma: keep
...
class Table : virtual public Abstract_table {
 public:
  ...
  typedef Collection<Materialized_view_log *> Mlog_collection;
  typedef Collection<Materialized_view *> Materialized_view_collection;
  ...
  */
  ...
  virtual Materialized_view_log *add_mlog() = 0;
  virtual Materialized_view_log *get_mlog_info() = 0;
  virtual const Materialized_view_log *get_mlog_info() const = 0;
  virtual bool is_mlog() const = 0;

  virtual bool has_mlog() const = 0;
  virtual const String_type &mlog_name() const = 0;
  virtual const String_type &mlog_db_name() const = 0;
  ...
  virtual Materialized_view *add_mv() = 0;
  virtual Materialized_view *get_mv_info() = 0;
  virtual const Materialized_view *get_mv_info() const = 0;

  virtual void copy_mv_info(const Table *tab_obj) = 0;
  virtual void drop_all_mv() = 0;
