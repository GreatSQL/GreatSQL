...
#ifndef DD__ORACLE_TYPE_IMPL_INCLUDED
#define DD__ORACLE_TYPE_IMPL_INCLUDED
...
class Oracle_type_impl : public Routine_impl, public Oracle_type {
 public:
  Oracle_type_impl();

  ~Oracle_type_impl() override {}
 ...
 public:
  ...
  bool update_name_key(Name_key *key) const override {
    return Routine_impl::update_name_key(key);
  }
 ...
 private:
  Oracle_type_impl(const Oracle_type_impl &src);
  Oracle_type_impl *clone() const override {
    return new Oracle_type_impl(*this);
  }

  Oracle_type *clone_dropped_object_placeholder() const override {
    Oracle_type_impl *placeholder = new Oracle_type_impl();
...
#endif  // DD__ORACLE_TYPE_IMPL_INCLUDED
