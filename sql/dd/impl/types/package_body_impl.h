...
#ifndef DD__PACKAGE_BODY_IMPL_INCLUDED
#define DD__PACKAGE_BODY_IMPL_INCLUDED
...
class Package_body_impl : public Routine_impl, public Package_body {
 public:
  Package_body_impl() : Routine_impl() { set_type(RT_PACKAGE_BODY); }

  ~Package_body_impl() override {}
 ...
 private:
  Package_body_impl(const Package_body_impl &src);
  Package_body_impl *clone() const override {
    return new Package_body_impl(*this);
  }

  Package_body *clone_dropped_object_placeholder() const override {
    Package_body_impl *placeholder = new Package_body_impl();
...
#endif  // DD__PACKAGE_BODY_IMPL_INCLUDED
