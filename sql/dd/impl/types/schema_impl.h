...
class Schema_impl : public Entity_object_impl, public Schema {
 ...
 public:
  ...
  Package_body *create_package_body(THD *thd) const override;

  Package_spec *create_package_spec(THD *thd) const override;

  Oracle_type *create_ora_type(THD *thd) const override;
