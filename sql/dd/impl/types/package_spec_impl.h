...
#ifndef DD__PACKAGE_SPEC_IMPL_INCLUDED
#define DD__PACKAGE_SPEC_IMPL_INCLUDED
...
class Package_spec_impl : public Routine_impl, public Package_spec {
 public:
  Package_spec_impl() : Routine_impl() { set_type(RT_PACKAGE_SPEC); }

  ~Package_spec_impl() override {}
 ...
 private:
  Package_spec_impl(const Package_spec_impl &src);
  Package_spec_impl *clone() const override {
    return new Package_spec_impl(*this);
  }
  Package_spec_impl *clone_dropped_object_placeholder() const override {
    Package_spec_impl *placeholder = new Package_spec_impl();
...
#endif  // DD__PACKAGE_SPEC_IMPL_INCLUDED
