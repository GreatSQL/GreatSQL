...
#include "sql/dd/impl/system_views/materialized_view.h"  //Materialized_views
#include "sql/dd/impl/system_views/mlog.h"        // Materialized_view_logs
...
void System_tables::add_remaining_dd_tables() {
  ...
  register_table<Materialized_view_logs>(core);
  register_table<Materialized_views>(core);
  ...
  */
  ...
  register_table("clone_history", system);
...
void System_views::init() {
  ...
  register_view<dd::system_views::Materialized_view_logs>(is);
  register_view<dd::system_views::Materialized_views>(is);
  register_view<dd::system_views::Materialized_view_usages>(is);
