...
template Object_id Storage_adapter::next_oid<Package_spec>();
template Object_id Storage_adapter::next_oid<Package_body>();
template Object_id Storage_adapter::next_oid<Oracle_type>();
...
template bool Storage_adapter::drop(THD *, const Package_spec *);
template bool Storage_adapter::store(THD *, Package_spec *);
template bool Storage_adapter::drop(THD *, const Package_body *);
template bool Storage_adapter::store(THD *, Package_body *);
template bool Storage_adapter::drop(THD *, const Oracle_type *);
template bool Storage_adapter::store(THD *, Oracle_type *);
