...
int Trans_delegate::before_commit(THD *thd, bool all,
  ...
  param.is_empty_transaction = is_empty_transaction_arg;
  ...
  /**
    ...
    If the transaction is started by a slave worker of MGR,
...
int Trans_delegate::trans_begin(THD *thd, int &out) {
  ...
  */
  if (m_rollback_transaction_on_begin && !thd->is_mgr_slave()) {
