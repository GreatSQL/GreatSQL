...
*/
#define SP_PSI_STATEMENT_INFO_COUNT 28
...
class sp_package : public sp_head {
  ...
  */
  ...
  // this package body's package head
  sp_package *m_package_head;
  ...
  sp_variable *find_package_head_variable(LEX_CSTRING udt) const;
  bool find_package_cursor(LEX_STRING name, uint *poff) const;
  bool find_package_head_cursor(LEX_STRING name, uint *poff) const;
