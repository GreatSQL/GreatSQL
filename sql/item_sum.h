...
class Item_sum : public Item_func {
  ...
  */
  ...
  bool is_forced_const() { return forced_const; }
  void set_forecd_const(bool is_forced_const) {
    forced_const = is_forced_const;
  }
...
class Item_sum_sum : public Item_sum_num {
 ...
 public:
  ...
  void set_result_type(Item_result type) { hybrid_type = type; }
...
class Item_func_group_concat final : public Item_sum {
 ...
 public:
  ...
  const char *func_name() const override {
    if (orafun == 1) return "listagg";
    if (orafun == 2) return "wm_concat";
    return "group_concat";
  }
  Item_result result_type() const override { return STRING_RESULT; }
...
class Item_row_number : public Item_non_framing_wf {
 ...
 public:
  ...
  Item *pq_clone(THD *thd MY_ATTRIBUTE((unused)),
                 Query_block *select MY_ATTRIBUTE((unused))) override {
    return this;
  }
};
...
class Item_lead_lag final : public Item_non_framing_wf {
 ...
 public:
  ...
  Item *pq_clone(THD *thd MY_ATTRIBUTE((unused)),
                 Query_block *select MY_ATTRIBUTE((unused))) override;
  Item *m_origin_args0{nullptr};
  Item *m_origin_args2{nullptr};
...
class Item_rollup_sum_switcher final : public Item_sum {
 public:
  ...
  Item *pq_clone(THD *thd, Query_block *select MY_ATTRIBUTE((unused))) override;
  int get_num_levels() { return m_num_levels; }
