...
class Item_func_cursor_bool : public Item_bool_func, public Cursor_ref {
 public:
  Item_func_cursor_bool(LEX_CSTRING name, uint offset, sp_variable *cursor_spv,
      ...
      : Item_bool_func(), Cursor_ref(name, offset, cursor_spv, rh) {}
...
class Item_func_cursor_found : public Item_func_cursor_bool {
 public:
  Item_func_cursor_found(LEX_CSTRING name, uint offset, sp_variable *cursor_spv,
                         const Sp_rcontext_handler *rh)
      : Item_func_cursor_bool(name, offset, cursor_spv, rh) {}
...
class Item_func_record_table_forall_bool : public Item_bool_func {
 ...
 public:
  Item_func_record_table_forall_bool(Item *item_i, LEX_STRING ident_name,
                                     int offset)
      : Item_bool_func(),
        m_item(item_i),
...
class Item_func_case final : public Item_func {
 ...
 public:
  Item_func_case(const POS &pos, mem_root_deque<Item *> *list,
                 Item *first_expr_arg, Item *else_expr_arg, int ora_arg = 0)
      : super(pos),
        first_expr_num(-1),
        else_expr_num(-1),
