...
constexpr const uint64_t OPTIMIZER_SWITCH_FAVOR_RANGE_SCAN{1ULL << 27};
constexpr const uint64_t OPTIMIZER_SWITCH_REMOVE_USELESS_OUTERJOIN{1ULL << 28};
constexpr const uint64_t OPTIMIZER_SWITCH_DERIVED_LIMIT_PUSHDOWN{1ULL << 29};
constexpr const uint64_t OPTIMIZER_SWITCH_LAST{1ULL << 30};
