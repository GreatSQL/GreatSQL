...
class Sql_condition {
  ...
  */
  ...
  /**
    Get the user-defined excption of this condition.
    @return the user-defined excption condition item.
  */
  sp_condition_value *get_user_defined() const { return m_user_defined; }
  ...
  */
  ...
  /**  Set sp-user-defined condition value int this condition*/
  void set_user_defined_exception(sp_condition_value *value);
  ...
  */
  ...
  /** Oracle cmp extension, user-defined exception condition item */
  sp_condition_value *m_user_defined;
...
class Diagnostics_area {
  ...
  */
  void set_error_status(uint mysql_errno, const char *message_text,
                        const char *returned_sqlstate,
                        sp_condition_value *value = nullptr);
 ...
 */
  ...
  */
  ...
  /**
    @return user-defined exception condition item
  */
  sp_condition_value *user_defined() const;

  const char *pop_one_condition_from_da() {
    if (!m_conditions_list.elements()) return nullptr;
    return m_conditions_list.pop_front()->message_text();
  }
...
class Dbms_output_package {
  Diagnostics_area m_dbms_da;
  Diagnostics_area *m_dbms_da_ptr;
  bool m_buf_enabled;
  bool m_server_output;

 public:
  Dbms_output_package()
      : m_dbms_da(false),
        m_dbms_da_ptr(&m_dbms_da),
        m_buf_enabled(false),
        m_server_output(false) {}
  /** Destructor. */
  ~Dbms_output_package() {}
  ...
  void set_serveroutput(THD *thd, bool val) {
    set_buf_enabled(thd, val);
    m_server_output = val;
  }

  void reset_dbms_output_package(THD *thd) {
    m_dbms_da_ptr->reset_condition_info(thd);
  }  // reset dbms output content

  const char *get_line() { return m_dbms_da_ptr->pop_one_condition_from_da(); }
  char *get_lines() { return nullptr; }
  uint get_buf_count() { return m_dbms_da_ptr->cond_count(); }
};
