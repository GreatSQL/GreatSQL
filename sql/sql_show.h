...
/// Represents SHOW CREATE PACKAGE statement.

class Sql_cmd_show_create_package : public Sql_cmd_show_noplan {
 public:
  Sql_cmd_show_create_package()
      : Sql_cmd_show_noplan(SQLCOM_SHOW_CREATE_PACKAGE) {}
  bool check_privileges(THD *thd) override;
  bool execute_inner(THD *thd) override;
};

/// Represents SHOW CREATE PACKAGE BODY statement.

class Sql_cmd_show_create_package_body : public Sql_cmd_show_noplan {
 public:
  Sql_cmd_show_create_package_body()
      : Sql_cmd_show_noplan(SQLCOM_SHOW_CREATE_PACKAGE_BODY) {}
  bool check_privileges(THD *thd) override;
  bool execute_inner(THD *thd) override;
};
...
class Sql_cmd_show_create_synonym : public Sql_cmd_show_noplan {
 public:
  ...
  bool check_privileges(THD *thd) override;
  bool execute_inner(THD *thd) override;
  Table_ident *table_ident() { return m_table_ident; }
...
/// Represents SHOW CREATE Materialized view  statement

class Sql_cmd_show_create_materialized_view : public Sql_cmd_show_noplan {
 public:
  Sql_cmd_show_create_materialized_view(Table_ident *table_ident)
...
/// Represents SHOW STATUS PACKAGE statement.

class Sql_cmd_show_status_package : public Sql_cmd_show {
 public:
  Sql_cmd_show_status_package() : Sql_cmd_show(SQLCOM_SHOW_STATUS_PACKAGE) {}
};

/// Represents SHOW STATUS PACKAGE BODY statement.

class Sql_cmd_show_status_package_body : public Sql_cmd_show {
 public:
  Sql_cmd_show_status_package_body()
      : Sql_cmd_show(SQLCOM_SHOW_STATUS_PACKAGE_BODY) {}
};

/// Represents SHOW STATUS TYPE statement.

class Sql_cmd_show_status_type : public Sql_cmd_show {
 public:
  Sql_cmd_show_status_type() : Sql_cmd_show(SQLCOM_SHOW_STATUS_TYPE) {}
};
