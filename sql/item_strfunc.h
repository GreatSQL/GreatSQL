...
class Item_func_ora_oror : public Item_str_func {
  String tmp_value{"", 0, collation.collation};  // Initialize to empty
 public:
  Item_func_ora_oror(const POS &pos, Item *a, Item *b)
      : Item_str_func(pos, a, b) {}

  String *val_str(String *) override;
  bool resolve_type(THD *thd) override;
  const char *func_name() const override { return "ora_oror"; }
  enum Functype functype() const override { return ORA_OROR_FUNC; }
};
...
class Item_func_to_vector final : public Item_str_func {
 ...
 public:
  ...
  enum Functype functype() const override { return TO_VECTOR; }
  String *val_str(String *str) override;
};
...
class Item_func_from_vector final : public Item_str_func {
 public:
  ...
  enum Functype functype() const override { return FROM_VECTOR; }
  String *val_str(String *str) override;
};
...
class Item_func_table_first final : public Item_str_func {
 ...
 public:
  explicit Item_func_table_first(const POS &pos, uint spv_idx,
      ...
      : Item_str_func(pos), m_spv_idx(spv_idx), m_rcontext_handler(rh) {}
...
class Item_func_alter_all_event : public Item_str_func {
 private:
  String buf1, buf2, buf3;

 public:
  Item_func_alter_all_event(const POS &pos, Item *a, Item *b, Item *c)
      : Item_str_func(pos, a, b, c) {}
  bool resolve_type(THD *) override {
    set_data_type_string(512, system_charset_info);
    set_nullable(true);
    null_on_null = false;
    return false;
  }
  String *val_str(String *) override;
  const char *func_name() const override { return "alter_all_event"; }
};
