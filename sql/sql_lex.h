...
struct LEX : public Query_tables_list {
  ...
  */
  ...
  bool sp_variable_declarations_copy_type_finalize(
      THD *thd, int nvars, sp_variable *spvar_ident, LEX_CSTRING def_type,
      const Sp_rcontext_handler *rh_ident, sp_head *sph);
  ...
  */
  ...
  bool check_foral_i_ident(THD *thd, PT_query_expression_body *insert_query);
  /**oracle sp end **/
