...
class Prepared_statement final {
  ...
  */
  ...
  bool m_esn_state{false};  /// A copy of emptystring_equal_null mode.
 ...
 private:
  ...
  bool insert_parameters(THD *thd, String *query, bool has_new_types,
                         PS_PARAM *parameters,
                         enum enum_param_pack_type param_pack_type);
  // MERGE_PS8404_CHECK_TAG: @linlj if need add param enum_param_pack_type ?
  bool send_statement(THD *thd, uint no_columns, Query_result *result,
