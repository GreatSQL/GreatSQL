...
static const char *errorlog_messages_lc_name;
...
uint replication_error_write_file;
ulong opt_replica_parallel_wait_mode;
...
MY_LOCALE *my_default_errorlog_lc_messages;
MY_LOCALE *errorlog_lc_messages;
...
SHOW_VAR com_status_vars[] = {
    ...
    {"create_index",
     ...
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"create_package",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_CREATE_PACKAGE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"create_package_body",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_CREATE_PACKAGE_BODY]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"create_type",
    ...
    {"drop_index",
     ...
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"drop_package",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_DROP_PACKAGE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"drop_package_body",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_DROP_PACKAGE_BODY]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"drop_type",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_DROP_TYPE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"drop_procedure",
    ...
    {"execute_immediate",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_EXECUTE_IMMEDIATE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"compound_sql",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_COMPOUND]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"explain_other",
    ...
    {"insert_all_select",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_INSERT_ALL_SELECT]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"install_component",
     (char *)offsetof(System_status_var,
    ...
    {"show_create_package",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_CREATE_PACKAGE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"show_create_package_body",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_CREATE_PACKAGE_BODY]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"show_create_type",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_CREATE_TYPE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"show_create_proc",
     (char *)offsetof(System_status_var,
    ...
    {"show_package_status",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_STATUS_PACKAGE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"show_type_status",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_STATUS_TYPE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
#ifndef DBUG_OFF
    {"show_package_body_code",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_PACKAGE_BODY_CODE]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
#endif
    {"show_package_body_status",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_SHOW_STATUS_PACKAGE_BODY]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
    {"show_parse_tree",
    ...
    {"reload_sequence",
     (char *)offsetof(System_status_var,
                      com_stat[(uint)SQLCOM_RELOAD_SEQUENCES]),
     SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
...
#define SUPER_LARGE_PAGESIZE (256 * 1024 * 1024) /* 256MB */
  ...
  while (!(my_default_errorlog_lc_messages =
               my_locale_by_name(nullptr, errorlog_messages_lc_name,
                                 strlen(errorlog_messages_lc_name)))) {
    LogErr(ERROR_LEVEL, ER_FAILED_TO_FIND_LOCALE_NAME,
           errorlog_messages_lc_name);
    if (!my_strcasecmp(&my_charset_latin1, errorlog_messages_lc_name,
                       mysqld_default_locale_name))
      return 1;
    errorlog_messages_lc_name = mysqld_default_locale_name;
  }
  errorlog_lc_messages = my_default_errorlog_lc_messages;
...
#endif
{
  ...
  */
  ...
  /* MERGE_PS8404_CHECK_TAG: @linyu, commented to compile OK, seems need un-comment and fix following codes
  void *argv_p = argv;
...
struct my_option my_long_options[] = {
    ...
    */
    ...
    {"lc-messages", 0, "Set the language used for the error messages.",
     ...
     nullptr, 0, nullptr},
    {"errorlog_messages_language", 0,
     "Set the language used for the error log messages.",
     &errorlog_messages_lc_name, &errorlog_messages_lc_name, nullptr, GET_STR,
     REQUIRED_ARG, 0, 0, 0, nullptr, 0, nullptr},
    {"lc-time-names", 0,
...
bool create_native_table_for_pfs(const Plugin_table *t) {
  ...
  bool error = false;
  error = do_create_native_table_for_pfs(thd, t);
  if (executing_statement_under_stored_program) {
    thd->is_internal_con_no_result = false;
  }
