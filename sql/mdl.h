 ...
 public:
  ...
  /**
    ...
    Different types of objects exist in different namespaces
     ...
     - PACKAGE_SPEC is for package spec and body. PACKAGE is defined elsewhere
       and could not be used. That's why PACKAGE_SPEC is taken here.
  ...
  */
  bool use_normalized_object_name() const {
    return (mdl_namespace() == FUNCTION || mdl_namespace() == PROCEDURE ||
            mdl_namespace() == PACKAGE_SPEC || mdl_namespace() == EVENT ||
