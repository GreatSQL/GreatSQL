...
/**  Clone system variable: how recovery from binlog, GTID or POSITION */
ulong clone_data_recovery_mode;
...
/** path name of the encrypt clone key file */
static MYSQL_SYSVAR_STR(encrypt_key_path, clone_encrypt_key_path,
...
/** If data is compressed in file layer. */
static const char *clone_data_recovery_str[] = {
    "CLONE_DATA_RECOVERY_GTID", "CLONE_DATA_RECOVERY_BINLOG_POSITION", nullptr};

static TYPELIB clone_data_recovery_typelib = {
    array_elements(clone_data_recovery_str) - 1, "clone_data_recovery_typelib",
    clone_data_recovery_str, nullptr};

static MYSQL_SYSVAR_ENUM(data_recovery_mode, clone_data_recovery_mode,
                         PLUGIN_VAR_RQCMDARG,
                         "when do recovery after recovery, how to sync newest "
                         "data from binlog: GTID or binary file position.",
                         NULL, NULL,
                         clone_data_recovery_mode_t::CLONE_DATA_RECOVERY_GTID,
                         &clone_data_recovery_typelib);
...
static SYS_VAR *clone_system_variables[] = {
    ...
    MYSQL_SYSVAR(data_recovery_mode),
    nullptr};
