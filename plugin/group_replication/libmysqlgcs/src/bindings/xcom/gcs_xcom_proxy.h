 ...
 */
  ...
  */
  ...
  virtual bool xcom_client_set_expel_timeout(uint64_t timeout) = 0;
  ...
  */
  ...
  virtual bool xcom_set_expel_timeout(uint64_t timeout) = 0;
...
class Gcs_xcom_proxy_base : public Gcs_xcom_proxy {
 public:
  ...
  bool xcom_set_expel_timeout(uint64_t timeout) override;
...
class Gcs_xcom_proxy_impl : public Gcs_xcom_proxy_base {
 public:
  ...
  bool xcom_client_set_expel_timeout(uint64_t timeout) override;
...
class Gcs_xcom_app_cfg {
 public:
  ...
  void set_xcom_expel_timeout(uint64_t timeout);
