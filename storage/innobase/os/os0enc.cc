...
bool Encryption::fill_encryption_info(
  ...
  */
  ...
  if (encrypt_key) {
    /* Encrypt key and iv. */
    auto elen =
        my_aes_encrypt(key_info, sizeof(key_info), ptr, master_key, KEY_LEN,
                       MY_DEFAULT_ECB_256_MODE, nullptr, false);
...
bool Encryption::decode_encryption_info(space_id_t space_id,
  ...
  if (decrypt_key) {
    ...
    auto len = my_aes_decrypt(ptr, sizeof(key_info), key_info, master_key,
                              KEY_LEN, MY_DEFAULT_ECB_256_MODE, nullptr, false);
  ...
  switch (m_type) {
    ...
    case AES: {
      ...
      auto elen = my_aes_encrypt(
          ...
          MY_DEFAULT_CBC_256_MODE, m_iv, false);
      ...
      if (remain_len != 0) {
        ...
        elen = my_aes_encrypt(
            ...
            static_cast<uint32>(m_klen), MY_DEFAULT_CBC_256_MODE, m_iv, false);
