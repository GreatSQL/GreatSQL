...
static void set_second_behind_group(void *const context,
                                    unsigned long long int value) {
...
Plugin_table table_replication_group_member_stats::m_table_def(
    ...
    "  SECOND_BEHIND_GROUP BIGINT unsigned not null\n",
    /* Options */
    ...
    if (read_all || bitmap_is_set(table->read_set, f->field_index())) {
      switch (f->field_index()) {
        ...
        case 12:
          ...
          break;
        case 13:
          set_field_ulonglong(f, m_row.second_behind_group);
          break;
        default:
          assert(false);
      }
