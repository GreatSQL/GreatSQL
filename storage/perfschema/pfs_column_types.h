...
enum enum_object_type : char {
  ...
  OBJECT_TYPE_PACKAGE_SPEC = 6,
  OBJECT_TYPE_PACKAGE_BODY = 7,
  OBJECT_TYPE_TYPE = 8,

  /* Not advertised in SQL ENUM, only displayed as VARCHAR */

  OBJECT_TYPE_TEMPORARY_TABLE = 9,
  OBJECT_TYPE_GLOBAL = 10,
  OBJECT_TYPE_SCHEMA = 11,
  OBJECT_TYPE_COMMIT = 12,
  OBJECT_TYPE_USER_LEVEL_LOCK = 13,
  OBJECT_TYPE_TABLESPACE = 14,
  OBJECT_TYPE_LOCKING_SERVICE = 15,
  OBJECT_TYPE_SRID = 16,
  OBJECT_TYPE_ACL_CACHE = 17,
  OBJECT_TYPE_COLUMN_STATISTICS = 18,
  OBJECT_TYPE_BACKUP_LOCK = 19,
