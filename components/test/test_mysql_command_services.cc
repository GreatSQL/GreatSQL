...
/* test bug13509 */
static char *test_mysql_command_services_bug13509(UDF_INIT *, UDF_ARGS *args,
...
static mysql_service_status_t init() {
  ...
  Udf_func_string udf3 = test_mysql_command_services_bug13509;
  if (udf_srv->udf_register("test_mysql_command_services_bug13509",
                            STRING_RESULT, reinterpret_cast<Udf_func_any>(udf3),
                            nullptr, nullptr)) {
    fprintf(stderr,
            "Can't register the test_mysql_command_services_bug13509 UDF\n");
    return 1;
  }
  return 0;
}
...
static mysql_service_status_t deinit() {
  ...
  if (udf_srv->udf_unregister("test_mysql_command_services_bug13509",
                              &was_present))
    fprintf(stderr,
            "Can't unregister the test_mysql_command_services_bug13509 UDF\n");
  return 0; /* success */
}
