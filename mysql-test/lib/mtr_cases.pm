...
sub collect_one_test_case {
  ...
  my $result_t_file = "$resdir/$tname-p.result";
  my $result_file = "$resdir/$tname.result";
  # Use different result file if file exists for option mtr_hint
  if ($opt_mtr_hint and -f $result_t_file) {
    $tinfo->{result_file} = $result_t_file;
  } elsif (-f $result_file) {
