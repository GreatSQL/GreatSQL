...
GreatSQL开源数据库专注于提升MGR可靠性及性能，是适用于金融级应用的国内自主MySQL版本；可以作为MySQL或Percona Server的可选替换，用于线上生产环境；且完全免费并兼容MySQL或Percona Server。
...
# 版本特性
---
GreatSQL 5.7除了提升MGR性能及可靠性，还修复了众多BUG。
选用GreatSQl主要有以下几点优势：
