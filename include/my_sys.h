...
extern char *my_strerror_oserror(char *buf, size_t len, int errnum);
...
/* add for parallel load */
extern void move_io_cache(IO_CACHE *to, IO_CACHE *from);
[[nodiscard]]
...
extern bool dynstr_prepend(DYNAMIC_STRING *str, const char *prepend);
