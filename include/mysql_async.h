...
/* mtr-hint info read state in async cli */
enum mysql_async_mtr_hint_state_enum {
  MTR_HINT_IDLE = 0,
  MTR_HINT_READ_MSG,
  MTR_HINT_COMPLETE
};
...
#ifdef WITH_MTR_HINT
  /* state for reading mtr-hint info */
  enum mysql_async_mtr_hint_state_enum async_mtr_hint_state;
  size_t async_mtr_hint_length;
#endif
