...
enum mysql_option {
  ...
  MYSQL_LOAD_BALANCE_HOSTS,
  MYSQL_LOAD_BALANCE_STRATEGY,
  MYSQL_LOAD_BALANCE_BLOCKLIST_TIMEOUT
};
...
enum mysql_load_balance_strategy {
  LOAD_BALANCE_RANDOM,
...
struct st_mysql_options {
  ...
  bool mtr_hint, compress, named_pipe;
  /**
  ...
  */
  ...
  struct st_mysql_load_balance_options *load_balance;
};
...
typedef struct MYSQL {
  ...
  bool free_options; /* If free options in mysql_close */
