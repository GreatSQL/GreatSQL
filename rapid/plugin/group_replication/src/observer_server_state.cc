...
int group_replication_before_recovery(Server_state_param *param) { return 0; }
...
int group_replication_after_recovery(Server_state_param *param) { return 0; }
...
Server_state_observer server_state_observer = {
    ...
    group_replication_before_handle_connection, // before the client connects to
                                                // the server
