...
Group_member_info::Group_member_info(
    ...
    : Plugin_gcs_message(CT_MEMBER_INFO_MESSAGE), hostname(hostname_arg),
      port(port_arg), uuid(uuid_arg), status(status_arg),
      ...
      unreachable(false), role(role_arg), configuration_flags(0),
...
Group_member_info::Group_member_info(Group_member_info &other)
    : Plugin_gcs_message(CT_MEMBER_INFO_MESSAGE),
      hostname(other.get_hostname()), port(other.get_port()),
      uuid(other.get_uuid()), status(other.get_recovery_status()),
      ...
      unreachable(other.is_unreachable()), role(other.get_role()),
...
Group_member_info::Group_member_info(const uchar *data, uint64 len)
    : Plugin_gcs_message(CT_MEMBER_INFO_MESSAGE), gcs_member_id(NULL),
      member_version(NULL), unreachable(false),
