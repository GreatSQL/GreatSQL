...
site_def *get_site_def();
site_def *get_site_def_rw();
site_def *get_prev_site_def();
...
node_no get_maxnodes(site_def *site);
node_no get_nodeno(site_def *site);
...
static inline bool_t node_no_exists(node_no n, site_def *site) {
  return n < get_maxnodes(site);
}

static inline bool_t is_local_node(node_no n, site_def *site) {
...
/**
  ...
  @return
    ...
    @retval 0 if failure
*/
static inline server *get_server(site_def *s, node_no i) {
