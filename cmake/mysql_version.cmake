...
MACRO(GET_MYSQL_VERSION)
  ...
  IF(WITH_GREATDB)
    MYSQL_GET_CONFIG_VALUE("GREATDB_SERVER_VERSION_MAJOR" GREATDB_SERVER_MAJOR_VERSION)
    MYSQL_GET_CONFIG_VALUE("GREATDB_SERVER_VERSION_MINOR" GREATDB_SERVER_MINOR_VERSION)
    MYSQL_GET_CONFIG_VALUE("GREATDB_SERVER_VERSION_PATCH" GREATDB_SERVER_PATCH_VERSION)
    MYSQL_GET_CONFIG_VALUE("GREATDB_SERVER_VERSION_EXTRA" GREATDB_SERVER_EXTRA_VERSION)
    MYSQL_GET_CONFIG_VALUE("PRODUCT_NAME" PRODUCT_NAME)
    IF(NOT DEFINED GREATDB_SERVER_MAJOR_VERSION OR
       NOT DEFINED GREATDB_SERVER_MINOR_VERSION OR
       NOT DEFINED GREATDB_SERVER_PATCH_VERSION OR
       NOT DEFINED GREATDB_SERVER_EXTRA_VERSION OR
       NOT DEFINED PRODUCT_NAME)
      MESSAGE(FATAL_ERROR "VERSION file cannot be parsed.")
    ENDIF()

    SET(GREATDB_SERVER_VERSION
      "${GREATDB_SERVER_MAJOR_VERSION}.${GREATDB_SERVER_MINOR_VERSION}.${GREATDB_SERVER_PATCH_VERSION}${GREATDB_SERVER_EXTRA_VERSION}")

    MESSAGE(STATUS "GreatDB Server version: ${GREATDB_SERVER_VERSION}")

    SET(VERSION_SRC "${GREATDB_SERVER_VERSION}")

    # Set suffix to indicate that this is MySQL Server built for GreatDB Server
    SET(MYSQL_SERVER_SUFFIX "-${PRODUCT_NAME}${GREATDB_SERVER_VERSION}")
  ENDIF()
